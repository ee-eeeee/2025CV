...
def train(hyp, opt, device, callbacks):
    ...
    freeze = [f"model.{x}." for x in ([freeze] if isinstance(freeze, int) else freeze)]
...
def parse_opt(known=False):
    ...
    parser.add_argument('--noplots', action='store_true', help='disable plot saving')
    parser.add_argument('--optimizer', type=str, default='SGD', help='SGD, Adam, AdamW etc.')
    parser.add_argument('--cos-lr', action='store_true', help='use cosine learning rate scheduler')
    parser.add_argument('--linear-lr', action='store_true', help='use linear learning rate scheduler')
    # ...其他已有参数...
    ...
    parser.add_argument('--imgsz', '--img', '--img-siz e', type=int, default=320, help='train, val image size (pixels)')
    ...
    parser.add_argument('--b ucket', type=str, default='', help='gsutil bucket')
